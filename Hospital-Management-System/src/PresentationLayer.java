...
public class PresentationLayer {
    ...
    public PresentationLayer() {
        ...
        sl.createDoctor("Parvez Hossain", "Surgeon");
        sl.createDoctor("Al Amin", "ER");
        sl.createDoctor("Sohel Rana", "Neurology");
        sl.createDoctor("Doctor", "Spinal");

        /* create four patients + one dummy patient*/
        sl.createPatient("Ayesha Akhter", 1, 2, 1999);
        sl.createPatient("Atiya Fariha", 6, 20, 1993);
        sl.createPatient("Shirin Akhter", 5, 20, 1970);
        sl.createPatient("Abdul Sattar", 5, 4, 1958);
        sl.createPatient("Patient", 1, 2, 1993);

        /* 2 patients has one appointment and one prescription */
        sl.createAppointment("Parvez Hossain", "Ayesha Akhter", 4, 4, 2015);
        sl.createPrescription("Parvez Hossain", "Ayesha Akhter", "Viagra");

        sl.createAppointment("Al Amin", "Atiya Fariha", 3, 8, 2015);
        sl.createPrescription("Al Amin", "Atiya Fariha", "Medical Marihuana");

        /* 2 patients has two appointments with different doctors and two prescriptions. */
        sl.createAppointment("Parvez Hossain", "Shirin Akhter", 4, 4, 2015);
        sl.createPrescription("Parvez Hossain", "Shirin Akhter", "Weed");
        sl.createAppointment("Sohel Rana", "Shirin Akhter", 4, 4, 2015);
        sl.createPrescription("Sohel Rana", "Shirin Akhter", "Viagra");
        sl.createAppointment("Parvez Hossain", "Abdul Sattar", 3, 8, 2015);
        sl.createPrescription("Parvez Hossain", "Abdul Sattar", "Nyquil");
        sl.createAppointment("Al Amin", "Abdul Sattar", 3, 8, 2015);
        sl.createPrescription("Al Amin", "Abdul Sattar", "Dayquil");
